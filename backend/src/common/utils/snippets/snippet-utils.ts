import { SUPPORTED_LANGUAGES } from '@/common/constants/code-languages-constant';
import { ICodeLanguage, LanguageName } from '@/types/CodeLanguage';
import IParser = require('tree-sitter');

type IIndentationStyle =
  | { type: 'none' | 'mixed' | 'tab'; value: null }
...
function removeInitialWhitespaces(
  lines: string[],
  quantity: number = 1,
): string[] {
